...
//import com.example.itinereasebackend.api.model.ItineraryAttractionId;
...
//    }
//
//    public void update(ItineraryAttractionId itineraryAttractionId, ItineraryAttraction updatedItineraryAttraction) {
//        Optional<ItineraryAttraction> existingItineraryAttraction = _itineraryattractionRepository.findById(itineraryAttractionId.getId_itinerary());
//
//        if (existingItineraryAttraction.isPresent()) {
//            ItineraryAttraction itineraryAttractionToUpdate = existingItineraryAttraction.get();
//            if (itineraryAttractionToUpdate.getId().getId_attraction() == itineraryAttractionId.getId_attraction())
